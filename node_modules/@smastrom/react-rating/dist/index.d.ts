import { CSSProperties, ForwardRefExoticComponent, RefAttributes, Dispatch, SetStateAction } from 'react';
...
export type RatingChange = Dispatch<SetStateAction<number>> | ((selectedValue: number) => void | Promise<void>);
